...
<body>
	...
	<div class="with_input_msg">
		<img src="${pageContext.request.contextPath}/images/with_ok.png" alt="ok" /> <span>提现成功</span> <span>我们将在2-5个工作日内处理您的申请</span>
	</div>
	<div class="with_input_ok">
		<a href="${pageContext.request.contextPath}/duihuan/index?userId=${sessionScope.userId}" style="text-decoration:none;"><input type="button" value="完成" /></a>
	</div>
	</main>
	<script>
