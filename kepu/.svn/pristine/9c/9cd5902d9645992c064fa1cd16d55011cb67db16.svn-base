...
public class Logger {
	  // 日志的配置文件
    public static final String LOG_CONFIGFILE_NAME = "resources/log4j.properties";
    // 日志文件名在配置文件中的标签
    ...
    private Logger(String fileName) throws LogException {
     ...
     * @throws LogException
     */
    public synchronized static Logger getLogWriter() throws LogException {
        if (Logger == null) {
        	Logger = new Logger();
        }
        return Logger;
    ...
    public synchronized static Logger getLogWriter(String logFileName)
            throws LogException {
        if (Logger == null) {
   ...
   public  static void log(String logMsg) {
    ...
    private String getLogFileNameFromConfigFile() {
        try {
            ...
            // 在类的当前位置,查找属性配置文件log4j.properties
            ...
            if (fin != null) {
                ...
                System.err.println("无法打开属性配置文件: log4j.properties");
            }
        } catch (IOException ex) {
            System.err.println("无法打开属性配置文件: log4j.properties");
        }
