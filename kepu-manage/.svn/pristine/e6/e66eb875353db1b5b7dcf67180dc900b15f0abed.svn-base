...
<table class="table table-hover  table-bordered table-striped" style="margin-bottom: 0px;">
		   ...
		   <tr class="no-border">
		   	<input type="text" name = "userid" value = "${stUser.userid}"/>
            <td width="18%"><div align="right"><strong>昵称：</strong></div></td>
            <td width="34%"><input name="nickname" value = "${stUser.nickname}" /> </td>
            <td width="15%"><div align="right"><strong>手机号：</strong></div></td>
            <td><font color="red"><input type ="text" name = "mobile" value = "${stUser.mobile}" /></font></td>
          </tr>
          <tr>
	...
	<div>
		<table class="table table-hover  table-bordered table-striped" style="margin-bottom: 0px;">
		   ...
		   <tr class="no-border">
            ...
            <td>${stUserAccount.score}</td>
          </tr>
          <tr>
            <td><div align="right"><strong>积分详情：</strong></div></td>
            <td><a href="${pageContext.request.contextPath}/scoreDetail/scoreDetailList?">查看</a></td>
