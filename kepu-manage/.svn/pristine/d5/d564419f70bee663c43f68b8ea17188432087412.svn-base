...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/product/taskSave" onsubmit="return checkForm()">	 
	  ...
	  <div class="form-group">
	    <label class="col-sm-2 control-label">开启时间：</label>
	    <div class="col-sm-10">
	      <input type="text" readonly class="form-control"  value="<fmt:formatDate value="${product.starttime}" pattern="yyyy-MM-dd"/>" style="width: 150px">
	    </div>
	  </div>
	   <div class="form-group">
