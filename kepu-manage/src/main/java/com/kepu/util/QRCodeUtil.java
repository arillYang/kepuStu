...
public class QRCodeUtil {
	...
	public  String createQrcode(){
        ...
        while(true){
	        ...
	        s=new String(rands);
	      /*  if(userService.qrcodeISunique(s))
	        	break;*/
	        break;
        }
        return s;
	...
	public static void encode(String content, String imgPath, String destPath,
			boolean needCompress,String file) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static void encode(String content, String imgPath, String destPath,String file)
			throws Exception {
	...
	public static void main(String[] args) throws Exception {
		//http://www.qqqgxx.com/userrecommand.jsp？code=1234
		//String fileName=getQcode();
		//String text = "http://www.qqqgxx.com/userrecommand.jsp?code="+fileName;
		//QRCodeUtil.encode(text, "", "C:\\Users\\niepan\\Desktop", true,fileName);
