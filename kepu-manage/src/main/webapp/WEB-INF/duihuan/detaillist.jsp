...
<body>
		...
		<div class="content-body"
			...
			<div class="detaillist_list">
				<ul class="mui-table-view detaillist_l_ul">
					<li class="mui-table-view-cell mui-media detaillist_l_li"><a
						href="#"> <span class="mui-media-object mui-pull-right">+1</span>
							<div class="mui-media-body detaillist_l_text">
								阅读“关于清明祭祖，县政府通告来了！”
								<p class='mui-ellipsis'>2018/02/05 12:51:30</p>
							</div>
					</a></li>
					<li class="mui-table-view-cell mui-media detaillist_l_li"><a
						href="#"> <span class="mui-media-object mui-pull-right">+1</span>
	...
	<div class="detaillist_f_inner">
		<div class="detaillist_f_btn">
			<a href="${pageContext.request.contextPath}/duihuan/bank"><button>提现</button></a>
		</div>
		<div class="detaillist_f_btn">
			<a href="index.html"><button>兑换</button></a>
		</div>
	</div>
	</footer>
	<script>
