...
<header class="mui-bar mui-bar-nav" style="padding-right: 15px;">
    ...
    <a href="index.html"><h5 id='setting' class=" mui-pull-left mui-icon mui-icon-arrowleft"></h5></a>
</header>
...
<div id="pullrefresh" class="mui-content mui-scroll-wrapper">
    <div class="content-body record_body" style="margin-top: 53px;">
        ...
        <!--<div class="record_none">
            <div class="record_n_inner">
                <div class="record_n_img">
                    <img src="images/none.jpg" alt="record none" />
                </div>
                <div class="record_n_text">
                    <p>啊哦，木有奖品~</p>
                </div>
            </div>
        </div>-->
  ...
  <c:forEach items="${list }"  var="st">
        <div class="record_list">
            <div class="record_divide">
                ...
                <p><fmt:formatDate value="${st.recordtime }" pattern="yyyy-MM"/></p>
    
            </div>
            <ul class="mui-table-view record_l_ul">
                <li class="mui-table-view-cell mui-media record_l_li">
                    <a href="#">
                        <img class="mui-media-object mui-pull-left" src="${st.recordimg }">
                        <div class="mui-media-body">${st.recordname }
                            <p class='mui-ellipsis'>
                        <fmt:formatDate value="${st.recordtime }" pattern="yyyy-MM-dd hh:mm:ss"/></p>
                        </div>
                      </a>
                    <span class="mui-badge mui-badge-primary ranklist_num record_l_num">-${st.recordintegral }</span>
                </li>
            </ul>
        </div>
      </c:forEach>
