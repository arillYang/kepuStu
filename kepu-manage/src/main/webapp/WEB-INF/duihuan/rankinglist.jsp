...
<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/js/mui.min.js"></script>
	...
	<div id="pullrefresh" class="mui-content mui-scroll-wrapper">
		<div class="content-body">
			...
			<div class="ranking-bg"
				...
				<c:if test="${var.userid==currentUser.id }">
				<div class="user-img"><img src="${var.recordimg }" width="100%" /></div>
				...
				<div style="height:auto;">
					...
					<c:forEach items="${list }" var="var">
						<li class="mui-table-view-cell mui-media ranklist_list">
							<span class="ranklist_sort ranklist_sort_1">${var.recordid }</span>
							<a href="#">
								<img class="mui-media-object mui-pull-left" height="50px" width="50px" src="${var.recordimg }">
								<div class="mui-media-body">
									${var.recordname }
								</div>
							</a>
							<span class="mui-badge mui-badge-primary ranklist_num">${var.recordintegral }</span>
						</li>
						</c:forEach>
