...
积分详情更新页面
<form action="${pageContext.request.contextPath}/scoreDetail/UpdateScoreDetail" method="post" >
	<table class="table table-hover  table-bordered table-striped"
		style="margin-bottom: 0px;">
		<input id="scoreDetailId" name="scoreDetailId" type="hidden"
				value="${scoreDetail.scoreDetailId}" />
		<tr>
		...
		<tr class="no-border">
			...
			<td><input id="scoreRatio" name="scoreRatio" type="text"
				value="${scoreDetail.scoreRatio}" /></td>
		</tr>
		<tr>
			<td><div align="right">
					<strong>积分描述：</strong>
