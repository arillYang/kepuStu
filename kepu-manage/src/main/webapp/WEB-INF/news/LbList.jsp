	...
	<table class="table table-hover  table-bordered table-striped" style="margin-bottom: 0px;">
		  ...
		  <c:forEach var="news" items="${newsList}" varStatus="status">
		  	<tr>
		  		...
		  		<td>
		  			<button type="button" class="btn btn-info btn-xs" onclick="javascript:window.location.href='${pageContext.request.contextPath}/news/preSave?id=${news.uid}'">编辑</button>
