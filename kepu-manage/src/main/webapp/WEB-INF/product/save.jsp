...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/product/save" onsubmit="return checkForm()">	 
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
           <div id="J_imageView_hot">
           		<c:forEach var="pic" items="${logo}" varStatus="status">
	           		<img src="${pic}"  style="width:10%;height:10%" onclick="showBigImg('${pic}')"  >
	        	</c:forEach>
           	</div>
	    </div>
	  </div>
	   <div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="username" name="username" value="${product.username}" style="width: 150px">
	    </div>
	  </div>
	  <div class="form-group">
