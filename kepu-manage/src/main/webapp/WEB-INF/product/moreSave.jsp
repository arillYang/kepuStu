...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/product/smallClassSave" onsubmit="return checkForm()">	 
	  <div class="form-group">
	    <label class="col-sm-2 control-label">标题：</label>
	    <div class="col-sm-10">
	      <input type="text" ${tab.tabtype==4?"readonly":""} class="form-control" id="tabname" name="tabname" value="${tab.tabname}" style="width: 300px">
	    </div>
	  </div>
