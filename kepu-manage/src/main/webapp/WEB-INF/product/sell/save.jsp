...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/product/sellSave" onsubmit="return checkForm()">	 
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="text" readonly class="form-control"  value="${product.config}" style="width: 150px">
	    </div>
	  </div>
	  <div class="form-group">
	    <label class="col-sm-2 control-label">装修：</label>
	    <div class="col-sm-10">
	      <input type="text" readonly class="form-control"  value="${product.decorate}" style="width: 150px">
	    </div>
	  </div>
	  <div class="form-group">
	    <label class="col-sm-2 control-label">户型(X室X厅X卫)：</label>
	    <div class="col-sm-10">
	      <input type="text" readonly class="form-control"  value="${product.housetype}" style="width: 150px">
	    </div>
	  </div>
	   <div class="form-group">
