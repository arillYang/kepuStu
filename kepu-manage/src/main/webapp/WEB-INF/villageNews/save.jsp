	...
	$("#village").change(function(){
		...
		if($.inArray("-100", temp)==0){
			if(flag==1){
				...
				$("#village").selectpicker('deselectAll');
			    flag=1;
			}
			$('#village').selectpicker('refresh');
		}
...
$(document).ready(function(){
	...
	function villageBind() {
	    ...
	    $("#village").html(""); 
	    //var str = "<option value='-100'>全部a</option>";
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/villageNews/save" onsubmit="return checkForm()">	 
	   ...
	   <div class="form-group">
	    ...
	    <!-- <div class="form-group">
		  <select id="id_select" class="selectpicker bla bla bli"  multiple data-live-search="true">
		     <option value="-100">==请选择===</option>
		     <option value="20001">赵岙</option>
		     <option value="20002">李家兴</option>
		     <option value="20003">黄坦树</option>
		     <option value="20004">下郭</option>
		     <option value="20005">下新屋</option>
		     <option value="20006">石板路</option>
		     <option value="20007">船山</option>
		     <option value="20008">上童</option>
		     <option value="20009">清口园</option>
		     <option value="20010">东坑</option>
		     <option value="20011">柴岭下</option>
		     <option value="20012">南门社区</option>
		     <option value="20013">小南门社区</option>
		     <option value="20014">水孔头社区</option>
		     <option value="20015">下垟底社区</option>
		     <option value="20016">管山社区</option>
		     <option value="20017">浮石园社区</option>
	  	  </select>
	  </div> -->
	  <div class="form-group">
