 ...
 * 
 * @param valid
 *            bool? true(valid)|false(invalid)|other(off) *
 * @param rule
 *            array 配置允许(valid)|不允许(invalid)的脚本规则：支持regex、string、function
 */
(function(valid, rule) {
