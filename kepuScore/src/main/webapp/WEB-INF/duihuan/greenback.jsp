...
<meta name="viewport"
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/co.js"></script>
    <style>
    	ol, ul{
    		margin: 0;
    		padding: 0;
...
<body>
	...
	<script>
		$(document).ready(function(){
			$('.green_btn input').on('click',function(){
				location.href="${pageContext.request.contextPath}/duihuan/index?userId="+${sessionScope.userId};
			})
		})
	</script>
